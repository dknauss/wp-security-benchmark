...
This repository contains AI-assisted WordPress security benchmark documentation. Portions of the documentation, planning notes, examples, tests, comments, or skill instructions may be drafted, revised, summarized, or reorganized with assistance from AI tools such as ChatGPT, Codex, Claude, Copilot, or Cursor.
